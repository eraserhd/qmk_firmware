...
// ,----------------------------------------------------------------------.       ,----------------------------------------------------------------.
      _______ , _______ , _______ ,  _______, _______ , _______ , _______ ,        _______ , _______, _______, _______, _______, _______,  _______ ,
// |----------+---------+---------+---------+---------+---------+---------|       |--------+--------+--------+--------+--------+--------+----------|
      _______ , _______ , _______ ,   KC_E  , _______ , _______ , _______ ,        _______ , KC_PPLS,  KC_7  ,  KC_8  ,  KC_9  , KC_PAST,  _______ ,
// |----------+---------+---------+---------+---------+---------|         |       |        |--------+--------+--------+--------+--------+----------|
      _______ ,   KC_A  , _______ ,   KC_D  ,   KC_F  , _______,/*--------|       |-------*/ KC_PMNS,  KC_4  ,  KC_5  ,  KC_6  , KC_PSLS,  _______ ,
// |----------+---------+---------+---------+---------+---------|         |       |        |--------+--------+--------+--------+--------+----------|
      _______ , _______ , _______ ,   KC_C  , _______ ,  KC_B   , _______ ,        _______ , KC_PEQL,  KC_1  ,  KC_2  ,  KC_3  , KC_DOT ,  _______ ,
// `----------+---------+---------+---------+---------+-------------------'       `-----------------+--------+--------+--------+--------+----------'
