...
// |----------+---------+---------+---------+---------+---------+---------|       |--------+--------+--------+--------+--------+--------+----------|
     _______  , KC_EXLM , KC_TILD , KC_LCBR , KC_RCBR , KC_AMPR , _______ ,        _______ , KC_HOME, _______, KC_INS , KC_END , KC_PGUP,  _______ ,
// |----------+---------+---------+---------+---------+---------|         |       |        |--------+--------+--------+--------+--------+----------|
...
// ,----------------------------------------------------------------------.       ,----------------------------------------------------------------.
      _______ , _______ , _______ ,  _______, _______ , _______ , _______ ,        _______ , _______, _______, _______, _______, _______,  _______ ,
// |----------+---------+---------+---------+---------+---------+---------|       |--------+--------+--------+--------+--------+--------+----------|
      _______ , _______ , _______ ,   KC_E  , _______ , _______ , _______ ,        _______ , KC_MINS,  KC_7  ,  KC_8  ,  KC_9  , KC_ASTR,  _______ ,
// |----------+---------+---------+---------+---------+---------|         |       |        |--------+--------+--------+--------+--------+----------|
      _______ ,   KC_A  , _______ ,   KC_D  ,   KC_F  , _______,/*--------|       |-------*/ KC_PLUS,  KC_4  ,  KC_5  ,  KC_6  , KC_DOT ,  _______ ,
// |----------+---------+---------+---------+---------+---------|         |       |        |--------+--------+--------+--------+--------+----------|
      _______ , _______ , _______ ,   KC_C  , _______ ,  KC_B   , _______ ,        _______ , KC_EQL ,  KC_1  ,  KC_2  ,  KC_3  , KC_SLSH,  _______ ,
// `----------+---------+---------+---------+---------+-------------------'       `-----------------+--------+--------+--------+--------+----------'
      _______ , _______ , _______ , _______ , _______ ,                                              _______ , _______, _______, _______, _______,
//   `------------------------------------------------'                                             `--------------------------------------------'
//                                                        ,-----------------.   ,-----------------.
