 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | SYMB   |   Q  |   W  |   E  |   R  |   T  |Leader|           |  L1  |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | CAPSL  |   A  |   S  |D/MNAV|F/KNAV|   G  |------|           |------|   H  |   J  |   K  |   L  |; / L2|' / SYMB|
 * |--------+------+------+------+------+------| Hyper|           | Meh  |------+------+------+------+------+--------|
